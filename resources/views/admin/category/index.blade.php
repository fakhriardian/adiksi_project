...
@section('content')
    ...
    <div class="p-8">
        <h2 class="text-4xl mb-6 font-extrabold dark:text-white">Categories Edit</h2>
                            ...
                            <td class="px-6 py-4 text-right">
                                ...
                                <div class="relative w-full h-full max-w-md md:h-auto">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="px-6 py-6 lg:px-8">
                                            <h3 class="mb-4 text-xl font-medium text-left text-gray-900 dark:text-white">Edit Category</h3>
                                            <form method="post" action="{{ route('category.update', $row->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <label for="countries"
