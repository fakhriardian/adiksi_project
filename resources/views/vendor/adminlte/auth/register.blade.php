                ...
                <div class="card" style="border-radius: 1rem;">
                    <div class="row g-0">
                        <div class="col-md-6 col-lg-5 d-none d-md-block">
                            <img src="store-image/adiksi3.png" alt="login form" class="img-fluid"
                            ...
                            <div class="card-body p-4 p-lg-5 text-black">
                                <form action="{{ $register_url }}" method="post">
                                    ...
                                    <div class="d-flex align-items-center mb-3 pb-1">
                                        <img src="/logo-images/adiksi_logo.png" class="border-0" alt="..."
                                            class="img-thumbnail" width="35" height="35">
                                    ...
                                    <div class="pt-1 mb-4">
                                        <button type=submit
                                            class="btn btn-dark btn-lg rounded btn-block {{ config('adminlte.classes_auth_btn', 'btn-flat btn-primary') }}">
