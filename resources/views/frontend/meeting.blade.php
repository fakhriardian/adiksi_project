...
@section('content')
<div class="absolute w-full h-screen blur-3xl bg-purple-50">
...
<div class="relative flex flex-col container mx-auto max-w-4xl h-fit bg-white/60 backdrop-blur-2xl py-4 px-6 rounded-2xl">
    <h3 class="text-gray-800 border-black border-b-2 capitalize w-fit px-4">
        meeting room
    </h3>
    <div class="flex flex-col justify-center items-center md:flex-row py-5 gap-10">
        <div class="bg-white w-60 h-fit rounded-lg px-3">
            <label for="countries_disabled" class="block text-xs text-gray-500 mt-2">Select an option</label>
            <select id="countries_disabled" class="text-gray-900 text-xl block w-full px-2.5 border-transparent focus:border-transparent focus:ring-0">
                <option value="US">meeting room 1</option>
        ...
        <div class="bg-white w-56 h-fit rounded-lg px-3">
            <div class="relative max-w-sm">
                ...
                <input type="date" name="date" class="text-gray-900 text-xl rounded-lg block w-full px-2.5 border-transparent focus:border-transparent focus:ring-0">
            </div>
        </div>
        <div class="bg-white w-40 h-fit rounded-lg px-3">
            <div class="relative max-w-sm">
                <label class="block text-xs text-gray-500 mt-2 capitalize">from time</label>
                <input type="time" class="text-gray-900 text-xl rounded-lg block w-full px-2.5 border-transparent focus:border-transparent focus:ring-0">
            </div>
        </div>
        <div class="relative">
            <i class="absolute -translate-y-2 text-2xl -rotate-90 fa-solid fa-arrow-turn-down"></i>
        </div>
        <div class="bg-white w-40 h-fit rounded-lg px-3">
            <div class="relative max-w-sm">
                <label class="block text-xs text-gray-500 mt-2 capitalize">to time</label>
                <input type="time" class="text-gray-900 text-xl rounded-lg block w-full px-2.5 border-transparent focus:border-transparent focus:ring-0">
            </div>
        </div>
    </div>
