        ...
        @foreach ($index as $item)
            <div
                ...
                <div class="flex flex-col justify-between lg:p-24 md:p-14 p-5 leading-normal">
                    ...
                    <h5 id="alice" class="mb-10 lg:text-7xl text-4xl font-bold tracking-tight text-gray-700 dark:text-white">
                        {{ $item->hero_head }}
                    </h5>
            ...
            <div class="lg:p-20 p-5 flex lg:mt-32 mt-0 flex-col items-center justify-between h-full lg:h-[60vh] overflow-y-hidden md:flex-row w-full bg-darkblue-800">
                <div class="flex flex-col md:p-14 p-0 md:mb-0 mb-10 w-full justify-center">
                    <h5 id="alice" class="lg:text-6xl lg:w-[50vh] w-full text-3xl font-bold tracking-tight text-white delay-[300ms] duration-[600ms] taos:translate-x-[-200px] taos:opacity-0" data-taos-offset="300">
                        {{ $item->card_head }}
                    </h5>
                ...
                <figure class="relative max-w-sm delay-[300ms] duration-[600ms] taos:translate-y-[200px] taos:opacity-0" data-taos-offset="300">
                    ...
                    <figcaption class="absolute px-4 text-lg text-white bottom-6">
                        <button data-tooltip-target="tooltip-no-arrow" data-tooltip-placement="bottom" type="button"
                            class="text-gold-800 bg-white z-10 hover:bg-gray-50 rounded-full md:-translate-y-40 -translate-y-0 md:-translate-x-[50px] -translate-x-0 p-5">
                            <svg aria-hidden="true" class="w-5 h-5s text-gold-800 dark:text-gray-600" viewBox="0 0 24 27"
            ...
            <div class="flex w-full md:flex-row flex-col justify-center">
                <h3 id="alice" class="md:p-20 p-5 my-auto font-bold md:w-[70vh] w-full md:text-5xl text-3xl delay-[300ms] duration-[600ms] taos:translate-x-[-200px] taos:opacity-0" data-taos-offset="300">
                    {{ $item->hl_head }}
                </h3>
            ...
            <div class="flex justify-end">
                <a href="/menu" class="inline-flex items-center mt-4 justify-center p-5 text-base font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
            ...
            <div class="flex flex-col md:p-20 p-5 items-center md:mt-14 mt-4 lg:flex-row w-full">
                ...
                <div class="lg:px-20 px-0 lg:mt-0 sm:mt-20 mt-14 flex flex-col justify-between p-4 leading-normal">
                    <h5 id="alice"
                        class="md:mb-12 mb-5 md:text-5xl text-2xl md:w-96 w-fit font-bold tracking-tight text-gray-900 delay-[300ms] duration-[600ms] taos:[transform:translate3d(200px,0,0)_scale(0.6)] taos:opacity-0" data-taos-offset="200">
                    {{ $item->mt_head }}
                    </h5>
                    ...
                    <a href="#" class="uppercase w-fit hover:underline underline-offset-8 text-gold-800 font-bold">
                        check availability
                    </a>
                </div>
            </div>
